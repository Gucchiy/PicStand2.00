========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : PicStand
========================================================================


AppWizard が生成した PicStand には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには PicStand を構成している各ファイルの概要説明が含まれています。
...
PicStand.h
    ...
    みます） をインクルードし、また CPicStandApp アプリケーションクラスを宣
    言します。

PicStand.cpp
    このファイルは CPicStandApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\PicStand.ico
    ...
    ルです。このアイコンはリソース ファイル PicStand.rc によってインクルード
    されます。
...
PicStandDlg.h, PicStandDlg.cpp - ダイアログ
    これらのファイルは CPicStandDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な PicStand.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) PicStand.pch 
